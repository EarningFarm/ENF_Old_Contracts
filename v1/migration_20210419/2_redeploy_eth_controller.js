...
const CFETHVaultV2 = artifacts.require("CFETHVaultV2");
const CFETHControllerV3 = artifacts.require("CFETHControllerV3");
...
async function performMigration(deployer, network, accounts, dhelper) {
  ...
  controler_contract = await dhelper.readOrCreateContract(CFETHControllerV3, [SafeMath, AddressArray, SafeERC20], crv, egap)
  ...
  //add seth pool
  await controler_contract.add_pool("0x7478064432745612B7944C3229ff7ece51bf3e3E");

  console.log("CFETHController: ", controler_contract.address);


  veth = "0xA709eCF2253B18A757214D64F42026Be8F008bD8";
  vault = await dhelper.readOrCreateContract(CFETHVaultV2, [SafeMath], veth, controler_contract.address)
  ...
  console.log("CFETHVault: ", vault.address);

  //to ringo first
  owner = "0xc3Fd2bcB524af31963b3E3bB670F28bA14718244"
  await controler_contract.transferOwnership(owner);
